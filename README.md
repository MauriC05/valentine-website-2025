...
```javascript
// Basic Information
valentineName: "Jayde"                    // Your Valentine's name
...
questions: {
    ...
    second: {
        ...
        startText: "I love you 3000!",                   // Text before percentage
...
// Final Celebration
celebration: {
    title: "I am the luckiest guy ever!",     // Celebration title
    message: "Enjoy your gifts!!!",          // Celebration message
